  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Title */}
        <h2 className="text-center fw-bold mb-1" style={{ fontSize: "1.75rem" }}>Join Government College of Engineering</h2>
        <p className="text-center text-muted mb-4" style={{ fontSize: "0.95rem" }}>Create your college-community account</p>
    ...
    <form onSubmit={handleSubmit}>
          ...
          {/* Graduation Year */}
          <div className="mb-3">
            <label className="form-label fw-semibold" style={{ fontSize: "0.95rem" }}>Graduation Year</label>
            <input
              type="text"
              className="form-control form-control-lg"
