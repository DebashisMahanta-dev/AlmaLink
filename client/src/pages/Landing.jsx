    ...
    <div className="landing-page">
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <h1 className="display-3 fw-bold mb-3">Bridge Your Future.<br />Connect with Alumni</h1>
              <p className="lead mb-4">
                Unlock career opportunities, mentorship, and a powerful network
              </p>
          ...
          <div className="row g-4">
            <div className="col-md-4 text-center">
              ...
              <p className="fst-italic text-muted">
                "Found my dream job through AlmaLink. The process was seamless!"
              </p>
      ...
      <section className="cta-section py-5 bg-primary text-white">
        <div className="container text-center">
          ...
          <p className="lead mb-4">
            Join thousands of students and alumni connecting to shape the future.
          </p>
        ...
        <div className="container">
          <div className="row mb-4">
            <div className="col-md-3">
              ...
              <p className="small" style={{ color: "#ccc", lineHeight: "1.6" }}>
                Connecting alumni and students for mutual growth.
              </p>
            </div>
            <div className="col-md-3">
          ...
          <div style={{ borderTop: "1px solid #444", paddingTop: "20px" }} className="text-center">
            <p className="small mb-0" style={{ color: "#999" }}>
              &copy; 2026 AlmaLink. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
