# GCE Connect - Web Application

A full-stack, college-only alumni and student portal for Government College of Engineering. Alumni can post job or internship opportunities, share experiences, and mentor students. Students can discover career opportunities and connect within the Government College of Engineering community.
...
- **Admin Governance**: Admin-only user role management with audit logs for admin actions
...
| ADMIN_ALLOWED_EMAIL_DOMAINS | (required for admin promotion)     | Comma-separated official domains allowed for admin role |
| ADMIN_ALLOWED_EMAILS        | (optional)                         | Comma-separated specific emails allowed for admin role  |
